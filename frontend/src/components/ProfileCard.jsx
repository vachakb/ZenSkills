...
const ProfileCard = () => {
  const interests = ['Web Dev', 'React', 'Bootstrap'];
        ...
        <Card className="shadow-sm pb-2 p-3 mb-1 mt-1 bg-white rounded text-primary">
          <div className="d-flex flex-column flex-md-row align-items-center">
            ...
            <div className="text-center text-md-start">
              <h5 className="mb-0 fs-4">Mentee 1</h5>
              <small className="text-muted">Student at XYZ University</small>
            </div>
          </div>

          <Card.Body className="mt-3">
            {/* Interests Section */}
            <Card.Title className="mt-0">Interests</Card.Title>
            <hr className="mb-2" />
