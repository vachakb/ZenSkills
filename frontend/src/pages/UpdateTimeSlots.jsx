...
import { updateTimeSlots } from "../apis/session";
            ...
            <Col className="d-flex justify-content-center align-items-center">
                ...
                <Row>
                    <Formik validationSchema={validationSchema} initialValues={initialValues} onSubmit={(data) => {
                        ...
                        updateTimeSlots(mentorId, data).then(() => navigate("/user_profile")).catch(err => console.error(err));
                    }}>
                        {({ values, handleSubmit, handleChange }) => (
                            <Form onSubmit={handleSubmit} style={{ border: "1px solid black", borderRadius: "10px", width: "1000px" }} className="px-4">
                                ...
                                <div className="form-footer">
                                    <Button type="submit" variant="primary" className="ms-auto next-button mb-3">
                                        Continue
                                    </Button>
                                </div>
                            </Form>
