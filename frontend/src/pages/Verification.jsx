            ...
            <Row>
              <Formik
                ...
                onSubmit={(data) => {
                  ...
                  body.append(
                    "government_id_type",
                    governmentIdMap[data.govid],
                  );
                  setIsVerifying(true);
                  // same for all the fields
                  uploadDocuments(body).then(() => {
                    setShowSuccessModal(true);
                    setIsVerifying(false);
                  }); // or however u called the endpoint in user.js
                }}
              >
                {(formikProps) => (
                  <Form
                  ...
                  >
                    <div className="text-center mb-0">
                      ...
                      <h1 className="my-4 fw-bold mb-0">
                    ...
                    >
                      <TextField
                        ...
                        isValid={
                          formikProps.touched.work_email &&
                          !formikProps.errors.work_email
                        }
                        isInvalid={
                          formikProps.touched.work_email &&
                          !!formikProps.errors.work_email
                      ...
                      <TextField
                        ...
                        onBlur={formikProps.handleBlur}
                        isValid={
                          formikProps.touched.change &&
                          !formikProps.errors.change
                        }
                        isInvalid={
                          formikProps.touched.change &&
                          !!formikProps.errors.change
                      ...
                      <Select
                        ...
                        isInvalid={
                          formikProps.touched.govid &&
                          !!formikProps.errors.govid
                        }
                      ...
                      <div className="d-flex flex-column gap-3 mb-0">
                        <label for="govid_image">
                          Upload Official ID Proof issued by The Government Of
                          India
                        </label>
                        <input
                          type="file"
